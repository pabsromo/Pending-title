...
/*void Oasis::drawLeaderboard()
{
vector<String> Initialsv = sortInitialVector();
vector<int> Scoresv = sortScoreVector();
int Score1 = Scoresv[0]; int Score2 = Scoresv[1]; int Score3 = Scoresv[2]; int Score4 = Scoresv[3]; int Score5 = Scoresv[4];
String Init1 = Initialsv[0]; String Init2 = Initialsv[1]; String Init3 = Initialsv[2]; String Init4 = Initialsv[3]; String Init5 = Initialsv[4];
String leader1InitScore = Init1 + " - " + to_string(Score1);
String leader2InitScore = Init2 + " - " + to_string(Score2);
String leader3InitScore = Init3 + " - " + to_string(Score3);
String leader4InitScore = Init4 + " - " + to_string(Score4);
String leader5InitScore = Init5 + " - " + to_string(Score5);
Text leaderBoard{ Point{ 350,500 }, "LEADERBOARD" }; // Leaderboard objects
Text leader1{ Point{ 350,520 }, leader1InitScore };
Text leader2{ Point{ 350,540 }, leader2InitScore };
Text leader3{ Point{ 350,560 }, leader3InitScore };
Text leader4{ Point{ 350,580 }, leader4InitScore };
Text leader5{ Point{ 350,600 }, leader5InitScore };

attach(leaderBoard); attach(leader1); attach(leader2); attach(leader3); attach(leader4); attach(leader5);
}*/
